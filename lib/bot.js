// Lógica del bot (WhatsApp y Telegram): recibe el texto (escrito o transcripto de un audio)
// y devuelve la respuesta. No habla con la app de mensajería; eso lo hacen api/whatsapp.js y api/telegram.js.
...
function crearBot({ datos, hoy, urlWeb, origen = 'whatsapp' }) {
  ...
  async function anotar(texto) {
    ...
    const guardados = await datos.agregar(r.items, origen);
